...
<div id="accordion">
  ...
  <div>
    <c:choose><c:when test='${fn:length(requestScope.pmvo.creatingProject)!=0||fn:length(requestScope.pmvo.joinProject)!=0||fn:length(requestScope.pmvo.processingProject)!=0}'><table border='5' >
  ...
  <div>
    <c:choose><c:when test='${fn:length(requestScope.pmvo.creatingProject)!=0}'><table border='5'><tr><td><c:forEach items='${requestScope.pmvo.creatingProject}' var='createP' varStatus='start'>
    		<table border= "3"><tr><td style='width: 700px'><a href='project_View.do?projectNo=${createP.projectNo}'>${createP.projectName}</a></td></tr> 
  			...
  			<tr><td>ID</td><td width="120px">분야</td><td width='350px'>내용</td><td width='160px' >접수일</td></tr><tr><td>${com.id}</td><td>${com.projectSub }</td><td>${com.content}</td><td>${com.commentDate} 
  ...
  <div>
    ...
    <c:choose><c:when test='${fn:length(requestScope.pmvo.joinProject)!=0}'><br><table border='5'>
  ...
  <div>
    <c:choose><c:when test='${fn:length(requestScope.pmvo.processingProject)!=0}'><table border='5'><tr><td width='600px'>프로젝트명</td>
    ...
    <a href='project_View.do?projectNo=${processP.projectNo}'>${processP.projectName}</a></td><td> <div id="progressbar${pro.index}"></div>
    ...
    <tr><td colspan="3"><div id="slider${pro.index }"></div></td></tr></c:when></c:choose></td></tr></c:forEach></table><br></c:when><c:otherwise></c:otherwise></c:choose>
  </div>
   <h3>완료<b> (${fn:length(requestScope.pmvo.successProject)})</b></h3>
  <div>
    <c:choose><c:when test='${fn:length(requestScope.pmvo.successProject)!=0}'><table border='5'><tr><td width='600px'>프로젝트명</td><td>완료일</td></tr>
