...
Exception Message <span style="margin-left: 100px"><a href="report_listView.do" class="hover_font">more</a></span><hr>
 ...
 <a href="report_showContent.do?error=${exception.exceptionMessage }&type=exception">${exception.exceptionMessage }</a><hr>
 </c:forEach>
</div>
...
Error Code <span style="margin-left: 150px"><a href="report_listView.do" class="hover_font">more</a></span><hr>
 ...
 <a href="report_showContent.do?error=${error.errorCode }&type=error">${error.errorCode }</a><hr>
 </c:forEach>
</div>
...
QnA Board <span style="margin-left: 480px" ><a href="QnA_listView.do" class="hover_font">more</a></span><hr>
 ...
 <span style="width:100px">${qna.qnaNo } </span> <span style="margin-left:100px; width:400px;"><a href="QnA_showContent.do?qnaNo=${qna.qnaNo }">${qna.title }</a></span><hr>
 </c:forEach>
 </div>
<div style="float: left; margin-top:50px ; width: 630px;">
Discuss Board <span style="margin-left: 460px" ><a href="discussion_listView.do" class="hover_font">more</a></span><hr>
 ...
 <span style="width:100px">${discuss.discussionNo } </span> <span style="margin-left:100px; width:400px;"><a href="findDiscussContent.do?no=${discuss.discussionNo}">${discuss.title }</a></span><hr>
 </c:forEach>
</div>
...
Project Recruitment <span style="margin-left: 415px" ><a href="#" class="hover_font">more</a></span><hr>
 ...
 <span style="width:100px">${project.projectNo } </span> <span style="margin-left:100px; width:400px;"><a href="project_View.do?projectNo=${project.projectNo }">${project.projectName }</a></span><hr>
 </c:forEach>
</div>
...
Video Board <span style="margin-left: 470px" ><a href="project_main.do" class="hover_font">more</a></span><hr>
 ...
 <span style="width:100px">${video.videoNo } </span> <span style="margin-left:100px; width:400px;"><a href="video_showContent.do?no=${video.videoNo }">${video.title }</a></span><hr>
 </c:forEach>
</div>
</div>
